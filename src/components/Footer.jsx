...
const Footer = () => {
  return (
    <footer className="flexCenter pd-24 pt-20">
      <div className="max_padd_container flex w-full flex-col gap-14">
        <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
          <Link to="/" className="mb-10 bold-20">Wima</Link>
        ...
        <p className="text-center regular-14 text-gray-30">2024 Wima | All rights reserved.</p>
      </div>
    </footer>
  );
}
