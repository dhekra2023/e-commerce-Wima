    ...
    <div className='flex-col flex'>
        ...
        <div className='mb-4'>
            ...
            <div className='flex flex-col gap-y-3 mb-4 max-w-[555px]'>
                <button className="btn_dark_outline !rounded-none uppercase
                regular-14 ">Add to cart</button>
                <button className="btn_dark_rounded !rounded-none uppercase
                regular-14 traking-widest">Buy it now</button>
            </div>
            <p><span className='medium-16 text-tertiary'>Category: </span>
            Women | Jacket | Winter</p>
            <p><span className='medium-16 text-tertiary'>Tags: </span> Modern | 
            Latest</p>
        </div>
    </div>
    </section>
